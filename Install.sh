...
setupConfigDir="/etc/tripwirepi"
tempsetupVarsFile="/tmp/setupVars.conf"
pivpnFilesDir="/usr/local/src/tripwirepi"
pivpnScriptDir="/opt/tripwirepi"
...
# TripwirePi we won't prompt to remove packages that may have been installed by the user for other reasons
INSTALLED_PACKAGES=()
...
main(){
	...
	if [[ "${runUnattended}" == true ]]; then
        ...
        # see which setup already exists SHOULD WORK WITHOUT THIS
